...
<body>
    <header>
        <nav class="navbar fixed-top navbar-expand-md navbar-light fixed-top bg-light scroll-nav">
            ...
            <div class="collapse navbar-collapse items" id="navbarCollapse">
                <ul class="navbar-nav navbar-center mr-auto item-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="border-radius: 0px;">
                            <a class="dropdown-item text-primary" href="servicios?service=1"><strong>DESARROLLO DE SOFTWARE</strong></a>
                            <a class="dropdown-item text-primary" href="servicios?service=2"><strong>SOPORTE TECNICO</strong></a>
                            <a class="dropdown-item text-primary" href="servicios?service=3"><strong>REDES INFORMATICAS</strong></a>
                        </div>
                    </li>
                    <li class="nav-item">
                ...
                <ul class="navbar-nav navbar-right mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-primary" href="#"><i class="fas fa-envelope-square"></i>ventas@gmail.com</a>
                    </li>
                </ul>
            </div>
        </nav>
    ...
    <div class="social">
        <ul>
            <li><a href="http://www.facebook.com/falconmasters" target="_blank" class="facebook"><i class="fab fa-facebook-f"></i></a></li>
            <li><a href="http://www.twitter.com/falconmasters" target="_blank" class="twitter"><i class="fab fa-twitter"></i></a></li>
            <li><a href="http://www.googleplus.com/falconmasters" target="_blank" class="google"><i class="fab fa-google-plus-g"></i></a></li>
            <li><a href="http://www.pinterest.com/falconmasters" target="_blank" class="youtube"><i class="fab fa-youtube"></i></a></li>
            <li><a href="mailto:contacto@falconmasters.com" class="mail"><i class="far fa-envelope"></i></a>
            </li>
        </ul>
    </div>
