<!-- Footer -->
<footer class="page-footer font-small unique-color-dark bg-dark footer1">
    ...
    <div class="container text-center text-md-left mt-5 text-white ">
        ...
        <div class="row mt-3">
            ...
            <div class="col-md-4 col-lg-2 col-xl-2 mx-auto mb-4">
                ...
                <hr class="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;">
                <p><a href="empresa"><i class="fas fa-bomb"></i> Misión</a></p>
                <p><a href="empresa"><i class="fas fa-bomb"></i>Vision</a></p>
                <p><a href="empresa"><i class="fas fa-bomb"></i>Equipo</a></p>
                <p><a href="portafolio"><i class="fas fa-bomb"></i>Fortafolio</a></p>
            </div>
            <!-- Grid column -->
